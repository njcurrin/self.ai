...
| F-009: config_path traversal in job create | P2 | routers/jobs.py:80 | NEW | T-065 |
| F-010: Log streaming generators never terminate | P2 | routers/jobs.py:170 | NEW | T-068 |
| F-011: Chat template upload uses raw dict | P2 | routers/system.py:45 | NEW | T-070 |
| F-012: GPU memory reports process-level not system-wide | P2 | state.py:733 | NEW | T-071 |
| F-013: Remaining print() in train.py | P3 | train.py:460 | NEW | — |
| F-015: Recursive size calc in list endpoints | P2 | routers/jobs.py:315 | NEW | — |
| F-016: Deprecated on_event startup | P3 | main.py:28 | NEW | — |
| F-017: No test coverage for health/system/model endpoints | P2 | tests/ | NEW | — |
| F-018: convert-to-gguf allows absolute path without validation | P2 | routers/pipeline.py:301 | NEW | T-066 |
