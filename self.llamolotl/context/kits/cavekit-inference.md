...
- [ ] Auto-detect unconverted safetensors adapters and delegate conversion to Pipeline domain (cavekit-pipeline.md R3)
**Dependencies:** none
...
- Model conversion/quantization (see cavekit-pipeline.md)

## Cross-References
- See also: cavekit-pipeline.md (produces GGUF models and LoRA adapters that inference loads)
- See also: cavekit-training.md (produces LoRA adapters that need conversion)
- See also: cavekit-platform.md (health endpoint patterns, logging standards)
